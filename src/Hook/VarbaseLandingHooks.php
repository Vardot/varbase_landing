...
/**
 * Hook implementations for the Varbase Landing module.
 */
class VarbaseLandingHooks {
  ...
  public function formNodeLandingPageEditFormAlter(&$form, FormStateInterface $form_state, $form_id): void {
  ...
  public function formNodeLandingPageFormAlter(&$form, FormStateInterface $form_state, $form_id): void {
    // Add the Varbase Bootstrap Paragraphs default admin styling.
    $form['#attached']['library'][] = 'varbase_bootstrap_paragraphs/vbp-default-admin';
  }
