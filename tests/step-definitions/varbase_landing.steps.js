...
/** Create and save a Landing page (title only; Components are optional). */
When(/^(?:I |we )?create a landing page titled "([^"]*)"$/, async function (title) {
  await gotoUrl(this.page, `${this.parameters.launchUrl}/node/add/landing_page`);
